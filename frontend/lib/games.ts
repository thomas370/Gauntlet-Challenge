...
export const POOL: Game[] = [
 ...
 { id: 25, name: "Moving Out 2", cat: "Coop", mode: "team", normal: "Finir un niveau", hardcore: "All medals sur un niveau", appid: 1641700 },
 ...
 { id: 81, name: "Final Sentence", cat: "Battle Royale", mode: "solo", normal: "Joueur tiré au sort Top 10 en Classic BR", hardcore: "Joueur tiré GAGNE une Classic BR ou un Duel", appid: 2413950 },
  ...
  // === ADDITIONS FROM "Idée Jeux Gauntlet" ===
  { id: 100, name: "Labyrinthine", cat: "Horror Coop", mode: "team", normal: "Finir un chapitre en coop", hardcore: "Finir un chapitre sans qu'aucun coéquipier ne meure", appid: 1302240 },
  { id: 101, name: "Getting Over It", cat: "Solo Champion", mode: "solo", normal: "Joueur tiré atteint l'arbre", hardcore: "Joueur tiré finit le jeu", appid: 240720 },
  { id: 102, name: "ALTF4", cat: "Party", mode: "solo", normal: "Joueur tiré finit un niveau", hardcore: "Joueur tiré finit un niveau Hard", cover: "/covers/altf4.jpg" },
  { id: 103, name: "Muck", cat: "Survie", mode: "team", normal: "Survivre 20 minutes en coop", hardcore: "Atteindre le Gold Chunk en coop", appid: 1625450 },
  { id: 104, name: "NBA 2K25", cat: "Sport", mode: "team", normal: "Win un match en MyTeam", hardcore: "Win 2 matchs Pro-Am d'affilée", appid: 2878980 },
  { id: 105, name: "Marathon", cat: "FPS Compétitif", mode: "team", normal: "Réussir une extraction en équipe", hardcore: "Réussir 3 extractions d'affilée en équipe", appid: 3065800 },
  { id: 106, name: "Gray Zone Warfare", cat: "FPS Compétitif", mode: "team", normal: "Finir une mission en coop", hardcore: "Finir une mission sans qu'aucun coéquipier ne meure", appid: 2479810 },
  { id: 107, name: "Delta Force", cat: "FPS Compétitif", mode: "team", normal: "Win un match Warfare en équipe", hardcore: "Win 2 matchs Warfare d'affilée", appid: 2507950 },
  { id: 108, name: "Arena Breakout: Infinite", cat: "FPS Compétitif", mode: "team", normal: "Réussir une extraction en équipe", hardcore: "Réussir une extraction Lockdown en équipe", appid: 2073620 },
  { id: 109, name: "ARK: Survival Evolved", cat: "Survie", mode: "team", normal: "Apprivoiser un dino niveau 30+ en coop", hardcore: "Battre un boss alpha en coop", appid: 346110 },
  { id: 110, name: "PixARK", cat: "Survie", mode: "team", normal: "Apprivoiser une créature en coop", hardcore: "Battre un boss en coop", appid: 593600 },
  { id: 111, name: "Plague Inc: Evolved", cat: "Solo Champion", mode: "solo", normal: "Joueur tiré tue le monde en Normal", hardcore: "Joueur tiré tue le monde en Brutal", appid: 246620 },
  { id: 112, name: "ARC Raiders", cat: "FPS Compétitif", mode: "team", normal: "Réussir une extraction en équipe", hardcore: "Réussir une extraction avec un boss tué", appid: 1808500 },
  { id: 113, name: "SCP: 5K", cat: "FPS Coop", mode: "team", normal: "Survivre une partie en coop", hardcore: "Finir l'objectif principal sans coéquipier mort", appid: 872670 },
  { id: 114, name: "SCP: Secret Laboratory", cat: "Horror Coop", mode: "solo", normal: "Joueur tiré survit et s'échappe en classe-D", hardcore: "Joueur tiré gagne 3 parties en classe-D", appid: 700330 },
  { id: 115, name: "The Division 2", cat: "FPS Coop", mode: "team", normal: "Finir une mission en coop", hardcore: "Finir une mission Hard sans qu'aucun coéquipier ne meure", appid: 2221490 },
  { id: 116, name: "60 Seconds! Reatomized", cat: "Solo Champion", mode: "solo", normal: "Joueur tiré survit 30 jours", hardcore: "Joueur tiré finit un scénario en Hard", appid: 1012880 },
  { id: 117, name: "UNO", cat: "Party", mode: "solo", normal: "Joueur tiré gagne une partie", hardcore: "Joueur tiré gagne 3 parties d'affilée", appid: 470220 },
  { id: 118, name: "Dark Hours", cat: "Horror Coop", mode: "team", normal: "Réussir un cambriolage en coop", hardcore: "Réussir un cambriolage sans déclencher d'alarme", appid: 2208570 },
  ...
  { id: 122, name: "Is This Seat Taken?", cat: "Puzzle", mode: "team", normal: "Finir un niveau", hardcore: "Finir un niveau dans le temps imparti", appid: 3035120 },
  ...
  { id: 126, name: "Escape From Tarkov", cat: "FPS Compétitif", mode: "team", normal: "Réussir une extraction en équipe", hardcore: "Tuer un boss et extraire en équipe", cover: "/covers/escape-from-tarkov.jpg" },
  { id: 127, name: "Overwatch 2", cat: "FPS Compétitif", mode: "team", normal: "Win un match Quick Play", hardcore: "Win un match Compétitif", appid: 2357570 },
  { id: 128, name: "Spelunky 2", cat: "Solo Champion", mode: "solo", normal: "Joueur tiré finit les Dwelling", hardcore: "Joueur tiré atteint Olmec", appid: 418530 },
  { id: 129, name: "The Crew Motorfest", cat: "Racing", mode: "team", normal: "Win une course en équipe", hardcore: "Win 3 courses d'affilée en équipe", appid: 2698940 },
  { id: 130, name: "Forza Horizon 5", cat: "Racing", mode: "team", normal: "Win une course Convoy", hardcore: "Win un PR Stunt en équipe", appid: 1551360 },
  { id: 131, name: "Forza Motorsport", cat: "Racing", mode: "solo", normal: "Joueur tiré P1 sur une course", hardcore: "Joueur tiré P1 sur une course Multiplayer", appid: 2440510 },
  { id: 132, name: "GRID Legends", cat: "Racing", mode: "team", normal: "Win une course Multiplayer", hardcore: "Win 3 courses d'affilée", appid: 1307710 },
  { id: 133, name: "Assetto Corsa", cat: "Racing", mode: "solo", normal: "Joueur tiré P1 sur une course Online", hardcore: "Joueur tiré bat son record sur un Hotlap", appid: 244210 },
  { id: 134, name: "Synth Riders", cat: "Solo Champion", mode: "solo", normal: "Joueur tiré FC une map Hard", hardcore: "Joueur tiré FC une map Master", appid: 885000 },
  { id: 135, name: "Gambonanza", cat: "Party", mode: "solo", normal: "Joueur tiré gagne une partie", hardcore: "Joueur tiré gagne 3 parties d'affilée", appid: 3509230 },
  ...
  { id: 137, name: "We Were Here Together", cat: "Puzzle", mode: "duo", normal: "2 joueurs tirés finissent un chapitre en coop", hardcore: "2 joueurs tirés finissent un chapitre dans le temps imparti", appid: 865360 },
